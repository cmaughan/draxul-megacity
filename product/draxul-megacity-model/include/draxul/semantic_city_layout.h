...
// CPU-only configuration consumed by semantic model, placement, grid, and
// routing code. The host adapts its broader product configuration at the
// boundary so model code does not need renderer, UI, or worker settings.
struct SemanticCityLayoutOptions
{
